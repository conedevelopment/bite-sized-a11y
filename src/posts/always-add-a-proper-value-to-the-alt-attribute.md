...
Always define the `alt` attribute on any image element to make it more understandable to the assistive technologies. Try to write a good and short (maximum 185 character) description and use empty value if it is decorative.
